...
#define STRING_CONFIG_H_AUTHOR "(eMc, ASTER LT1)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ASTER_E3V1
#endif
...
#define CUSTOM_MACHINE_NAME "Aster LT1"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "82a35391-bef7-44b8-b581-a3cc1344274b"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  19.37,  19.37 }
    #define DEFAULT_Ki_LIST {   1.11,   1.11 }
    #define DEFAULT_Kd_LIST { 170.40, 170.40 }
  #else
    #define DEFAULT_Kp  19.37
    #define DEFAULT_Ki   1.11
    #define DEFAULT_Kd 170.40
  #endif
#else
...
#define EXTRUDE_MINTEMP 160  // LT1 uses 160 rather than 170
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 6400, 6395.4}  // 4*3200/(20*2),8*3200/4*1,16*3*3200/(pi*8.0)*(100/95.6)  lwj TMC2208 XY*4 Z*8 E*16
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 29, -0.83 }
...
#define INVERT_E0_DIR false // set false for 1:3 extruder
...
#define Z_MAX_POS 255 // actually 250
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
//#define MIN_SOFTWARE_ENDSTOPS // disabled for LT1
...
// #define PREHEAT_1_TEMP_CHAMBER 35 // no chamber temp support
#define PREHEAT_1_FAN_SPEED     128 // Value from 0 to 255

#define PREHEAT_2_LABEL       "ABS"
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED    70
// #define PREHEAT_2_TEMP_CHAMBER 35 // no chamber temp support
...
#define FAN_SOFT_PWM // MUST enable
...
// :[0,1,2,3,4,5,6,7]
#define SOFT_PWM_SCALE 1 //0  0:7.8Hz,1:15.6Hz,2:31.2Hz,3:62.4Hz,4:124.8Hz,5:249.6Hz,6:499.2Hz,7:998.4Hz
